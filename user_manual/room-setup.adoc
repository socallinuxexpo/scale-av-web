...
* [ ] Place *Network Mixer* in a safe place on tray underneath *In-Room Audio Mixer* or if it doesn't fit, make room
...
ifdef::env-github[]
image:http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/socallinuxexpo/scale-av-web/plantuml-preview-github/user_manual/assets/network_mixer.puml[]
endif::[]
...
ifdef::env-github[]
image:http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/socallinuxexpo/scale-av-web/plantuml-preview-github/user_manual/assets/poe_injector_samsung.puml[]
endif::[]
...
ifdef::env-github[]
image:http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/socallinuxexpo/scale-av-web/plantuml-preview-github/user_manual/assets/poe_injector_ptzoptics.puml[]
endif::[]
...
ifdef::env-github[]
image:http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/socallinuxexpo/scale-av-web/plantuml-preview-github/user_manual/assets/camera_di_box.puml[]
endif::[]
...
ifdef::env-github[]
image:http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/socallinuxexpo/scale-av-web/plantuml-preview-github/user_manual/assets/samsung_camera.puml[]
endif::[]
